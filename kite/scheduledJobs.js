...
const zaireV3Params = {
    TOUCHING_SMA_TOLERANCE: 0.00035,
    TOUCHING_SMA_15_TOLERANCE: 0.00035,
    NARROW_RANGE_TOLERANCE: 0.0045,
...
const scheduleMISJobs = () => {
    ...
    sendMessageToChannel('⏰ Zaire V3 Scheduled - ', getDateStringIND(getEarliestTime(zaireJobV3, zaireJobV3_2)));
